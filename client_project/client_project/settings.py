...
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='http://127.0.0.1,http://localhost,https://47.128.240.242.nip.io', cast=Csv())
...
# For serving static files in production with compression and caching support.
